...
<div class="center-container">
    <div class="transparent-box">
        ...
        <div class="container"
            ...
            <h2>CREATE URN</h2>
            <form action="{{ route('postCreateUrn') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <label for="niche_id">Niche:
                    <select name="niche_id" id="niche_id">
                        ...
                        <option value="{{ $row->id_niche }}">{{ $row->building_name }} - Level-{{ $row->level }} - {{
                            $row->niche_number }}</option>
                        @empty
                ...
                <label>URN NUMBER: <input type="number" id="urn_number" name="urn_number" required></label>
