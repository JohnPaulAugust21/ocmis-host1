    ...
    <div class="d-flex ">
        ...
        <div class="  " style="height: 100vh;width:100%;top:20rem;max-height: 70svh;overflow-y: scroll ">
            <div class="  " style="padding: 3rem">
                <h1 class="text-white pb-3">{{ $building->name }}</h1>
                <div class="mb-4   d-flex gap-2   flex-wrap" style="max-width: 100%">
                    @forelse ($niches as $niche)
                    <a href="{{ route('forecastNiche',['id' => $niche->niche_id]) }}" class="text-reset text-decoration-none  " >
