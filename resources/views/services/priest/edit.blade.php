...
@section('content')
    <section x-data="dropdown({{ $schedules }})">
        <div class="sidebar">
        ...
        <div class="center-container" style=" 0px ;z-index: 50">
            <div class="transparent-box"
                ...
                <div>
                    <h2>EDIT Priest</h2>
                    <form action="{{ route('updatePriest', ['id' => $priest->priest_id]) }}" method="post"
                        enctype="multipart/form-data" class="d-flex justify-content-between  gap-10">
                        @csrf
