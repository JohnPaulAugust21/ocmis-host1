...
@section('content')
    <section x-data="dropdown">
        ...
        {{-- <div class="d-flex justify-content-center"
            style="padding-top: 7rem ;position: fixed; width: 100%; min-height: 100svh;top: 0;left:0;z-index: 9999;background:#0009">
            <form action="" class="bg-white col-4 p-4" style="height: fit-content">
                <div class="d-grid">
                    <div class="text-start">
                        <label for="" class="text-start">Start Time</label>
                        <input type="time" x-model="start" class="form-control">
                    </div>
                    <div class="text-start">
                        <label for="" class="text-start">End Time</label>
                        <input type="time" x-model="end" class="form-control">
                    </div>

                    <button type="button" x-on:click="alert('Hello World!')" class="btn btn-primary">Save changes</button>
