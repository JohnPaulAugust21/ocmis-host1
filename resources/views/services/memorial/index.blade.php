...
<div class="sidebar">
    <ul class="sidebar-nav">
        ...
        <li class="{{ request()->is('admin/services/memorial*') ? 'active' : '' }}">
            <a href="{{ route('serviceSales') }}">Online Memorial
            </a>
        </li>
    </ul>
</div>
...
<div class="container" style="margin-left: 120px;">
    ...
    <div class="container" style="margin-left: 100px;">
        ...
        <div class="svg-container" style="margin-left: 1028px; margin-bottom: 20px">
            <a href="{{route('createService')}}" class="svg-link">
        ...
        <table id="memorialTransactionTable" class="table table-layout">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Message</th>
