...
<div class="sidebar">
    <ul class="sidebar-nav">
        ...
        <li class="{{ request()->is('admin/shop/seller*') ? 'active' : '' }}">
...
<div class="center-container">
    <div class="transparent-box">
        ...
        <div class="container"
            ...
            <h2>EDIT SELLER</h2>
            <form action="{{ route('updateSeller', ['id' => $seller->seller_id]) }}" method="post"
                enctype="multipart/form-data">
                @csrf
                <label for="name">SUPPLIER NAME: <input type="text" id="name" name="name" value="{{$seller->name}}" required></label>
                <label for="contactnumber">CONTACT NUMBER: <input type="text" id="contactnumber" value="{{$seller->contactnumber}}" name="contactnumber" required></label>
                <label for="address">ADDRESS: <input type="text" id="address" name="address" value="{{$seller->address}}"  required></label>
