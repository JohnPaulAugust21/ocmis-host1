...
<div class="center-container">
    <div class="transparent-box">
        ...
        <div class="container"
            ...
            <h2>CREATE SELLER</h2>
            <form action="{{ route('postCreateSeller') }}" method="post" enctype="multipart/form-data">
                @csrf
                <label for="name">SUPPLIER NAME: <input type="text" id="name" name="name" required></label>
                <label for="contactnumber">CONTACT NUMBER: <input type="text" id="contactnumber" name="contactnumber" required></label>
