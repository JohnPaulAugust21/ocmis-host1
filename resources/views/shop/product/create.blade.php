...
<div class="center-container">
    <div class="transparent-box">
        ...
        <div class="container"
            ...
            <h2 style="margin-top: 150px;" >CREATE PRODUCT</h2>
            ...
            <form action="{{ route('postCreateProduct') }}" method="post" enctype="multipart/form-data">
                ...
                <label for="name">PRODUCT NAME: <input type="text" id="name" name="name" required></label>
                <label for="description">DESCRIPTION: <input type="text" id="description" name="description"
                        required></label>
                <label for="quantity">QUANTITY: <input type="number" id="quantity" name="quantity" required></label>
                <label for="price">PRICE: <input type="number" id="price" name="price" required></label>
