...
<div class="center-container">
    <div class="transparent-box">
        ...
        <div class="container"
            ...
            <form action="{{ route('postCreateShopCategory') }}" method="post" enctype="multipart/form-data">
                @csrf
                <label for="name">CATEGORY NAME: <input type="text" id="name" name="name" required></label>
